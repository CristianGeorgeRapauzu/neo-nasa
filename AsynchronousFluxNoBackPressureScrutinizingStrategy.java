...
public class AsynchronousFluxNoBackPressureScrutinizingStrategy implements ScrutinizingStrategy {

	private static final String ASYNCHRONOUS_FLUX_STRATEGY = "Asynchronous with Flux and no back-pressure";
	
	@Override
	public String getDescription() {
		return ASYNCHRONOUS_FLUX_STRATEGY;
	}
	 ...
	 * and extract NEO info from current page asynchronously - with Flux and no back-pressure
	...
	public void obtainNeoInfoFromBrowsedPages(NeoSummary neoSummary, int firstPageNumber) {
		...
		Long totalPages = neoSummary.getNeoCount() / 20; // ex: 18703/20 = 935
